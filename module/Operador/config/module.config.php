 ...
 *
 * @link      http://github.com/zendframework/ZendSkeletonOperador for the canonical source repository
        ...
        'routes' => array(
            'home' => array(
                ...
                'options' => array(
                    'route'    => '/',
                    'defaults' => array(
                        'controller' => 'Operador\Controller\Index',
                        'action'     => 'index',
                    ),
                ),
            ),
            ...
            // using the path /operador/:controller/:action
            'operador' => array(
                'type'    => 'Literal',
                'options' => array(
                    'route'    => '/operador',
                    'defaults' => array(
                        '__NAMESPACE__' => 'Operador\Controller',
                        'controller'    => 'Index',
                        'action'        => 'index',
                    ),
                ),
